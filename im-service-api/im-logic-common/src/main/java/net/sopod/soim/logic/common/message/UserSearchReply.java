...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              users_ = new java.util.ArrayList<net.sopod.soim.logic.common.message.UserInfo>();
  ...
  private java.util.List<net.sopod.soim.logic.common.message.UserInfo> users_;
  /**
   * <code>repeated .net.sopod.soim.logic.common.message.UserInfo users = 1;</code>
   */
  @java.lang.Override
  public java.util.List<net.sopod.soim.logic.common.message.UserInfo> getUsersList() {
    return users_;
  }
  /**
   * <code>repeated .net.sopod.soim.logic.common.message.UserInfo users = 1;</code>
  ...
  public static final class Builder extends
    ...
    private void ensureUsersIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        users_ = new java.util.ArrayList<net.sopod.soim.logic.common.message.UserInfo>(users_);
     ...
     * <code>repeated .net.sopod.soim.logic.common.message.UserInfo users = 1;</code>
     */
    public java.util.List<net.sopod.soim.logic.common.message.UserInfo.Builder> 
         getUsersBuilderList() {
