...
import net.sopod.soim.das.message.api.mq.ChatMQMessageConverter;
...
public class ChatPersistentRabbitMQConfiguration implements ImportBeanDefinitionRegistrar {
    ...
    @Bean
    public DasMQMessagePersistentService dasPersistentService(RabbitTemplate rabbitTemplate) {
        return new DasMQMessagePersistentService(rabbitTemplate);
    }
