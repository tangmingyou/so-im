package net.sopod.soim.client.cmd.console;

import com.google.common.base.*;
import com.google.common.collect.Iterables;
import net.sopod.soim.client.cmd.console.handlers.ConsoleBoxPasswordHandler;
...
public final class ConsoleBox {
     ...
     * @param keyValueSeparator the character used for representing black in a color
     * actually other colors, but since our image is only black and white
     * it will represent a shade, which in this case is aliasing.
     * @return the current instance
     */
